                ...
                <div>
                    ...
                    <div className="flex items-center gap-2 text-gray-500 text-sm mt-2">
                        ...
                        <span className="px-2 py-1 bg-gray-800 text-white rounded-full text-xs">
                            {translateRole(data.role.name)}
                        </span>
                    </div>
                </div>
                <Avatar src={data.avatar || "/img/default-avatar.png"} alt={data.fullName} size={64} />
            </div>

            <p className="text-gray-700 text-sm mt-4 mb-2">{data?.bio || "Loving books, coding, and coffee ☕"}</p>
