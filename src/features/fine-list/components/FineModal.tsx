...
const FineModal: React.FC<FineModalProps> = ({ openModal, setOpenModal, fineId = "" }) => {
    ...
    return (
        <Modal
            title={<h1 className="text-primary text-xl font-semibold mb-2 pb-2 border-b border-gray-300 text-center">Chọn phương thức thanh toán</h1>}
            open={openModal}
            onOk={handleOk}
