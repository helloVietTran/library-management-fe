...
import { Table, TableColumnsType, Tag, Modal, Select } from "antd";
...
import { BorrowRecord, Fine } from "@/types/types";
...
const FineTable: React.FC = () => {
  ...
  const { data: fineData, isLoading } = useFines(currentPage, pageSize, searchValue, filter);
  ...
  const columns: TableColumnsType<Fine> = [
    ...
    },
    {
      ...
      key: "collectedBy",
      render: (collectedBy: { fullName?: string }) => collectedBy?.fullName || "Chưa thu", 
    }
      ...
      <BoxContent>
        ...
        <div className="mt-4 flex justify-center">
          <Pagination
            ...
            pageSize={pageSize}
            totalElement={fineData?.totalElement}
