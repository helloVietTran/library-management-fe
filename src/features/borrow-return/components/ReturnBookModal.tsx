...
const ReturnBookModal: React.FC<ReturnBookModalProps> = ({ openModal, setOpenModal, recordId }) => {
    ...
    return (
        <Modal
            title={<h1 className="text-primary text-xl font-semibold mb-2 pb-2 border-b border-gray-300">Nhận sách</h1>}
            open={openModal}
            onOk={handleOk}
        ...
        >
            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: "Vui lòng chọn trạng thái sách." }]}
                >
                    <Select size="large">
