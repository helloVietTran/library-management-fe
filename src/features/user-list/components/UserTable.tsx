...
const UserTable: React.FC = () => {
    ...
    // Fetch users
    const { data: userData, isLoading } = useUsers(currentPage, pageSize, searchValue);
        ...
        <BoxContent>
            ...
            <div className="mt-4 flex justify-center">
                <Pagination
                    ...
                    pageSize={pageSize}
                    totalElement={userData?.totalElement}
                    handlePageChange={setCurrentPage}
                />
            </div>

            <UserModal openModal={openModal} setOpenModal={setOpenModal} userId={selectedUser?._id} />
            ...
            <Modal
                title={selectedUser?.status === "banned" ? "Mở khóa người dùng" : "Khóa người dùng"}
                open={isBanModalOpen}
            ...
            >
                <p>
                    ...
                    <strong>{selectedUser?.status === "banned" ? "mở khóa" : "khóa"}</strong> người dùng này không?
                </p>
            </Modal>
        </BoxContent>
    );
