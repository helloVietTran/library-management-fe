...
const StatisticCard: FC<StatisticCardProps> = ({
  ...
  return (
    <div className={`statistic-card w-full border-${borderRightColor} text-primary`}>
      ...
      <div className="flex items-center mt-2">
        ...
        <div>
          <div className={`flex items-center text-sm mt-2 ${difference >= 0 ? "text-green-500" : "text-red-500"}`}>
            {difference >= 0 ? (
